...
SUGGESTED FAQ COMPLETENESS (suggestedFAQ = the "Javasolt FAQ" section):
  ...
  - If there are 7 or more important blind spots, you MUST return between 7 and 9 FAQ questions. If there are exactly 6, return 6–8. If there are fewer than 6 blind spots, return one question per blind spot. Never stop early when more important blind spots exist.
